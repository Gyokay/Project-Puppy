...
router.post('/create-post',
  ...
  (req, res) => {
    ...
    // Validation
    req.checkBody('title', 'Title must be between ' +
      constants.minPostTitleLenght + ' and ' +
      constants.maxPostTitleLenght +
      ' characters')
      .len(constants.minPostTitleLenght, constants.maxPostTitleLenght)
    req.checkBody('description', 'Description must be between ' +
      constants.minPostDescriptionLenght + ' and '
      + constants.maxPostDescriptionLenght +
      ' characters')
